...
trait ListenersAliases {
   ...
   * [[swingio.scala.components.JButtonImplicits.JButtonIO#addMonadicActionListener]]*/
   ...
   * [[swingio.scala.components.JSliderImplicits.JSliderIO#addMonadicChangeListener]]*/
